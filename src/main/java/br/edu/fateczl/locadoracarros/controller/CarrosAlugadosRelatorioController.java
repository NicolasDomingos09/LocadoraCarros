/*
 * Aplicacao do SOLID
 * SRP (Single Responsibility Principle) - A classe tem uma única responsabilidade, que é gerar o relatório de carros alugados.
...
@Controller
@RequestMapping("/relatoriocarro")
public class CarrosAlugadosRelatorioController {
    ...
    @PostMapping("/gerar")
    public ResponseEntity relatorio(@RequestParam("data") String data, ModelMap model) {
        String erro = "";

        Map<String, Object> reportParams = new HashMap<>();
        reportParams.put("DATA", data);
        ...
        try {
			String path = "classpath:reports/CarrosAlugadosData.jasper";
