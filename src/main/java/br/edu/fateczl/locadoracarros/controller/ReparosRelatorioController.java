/*
 * Aplicacao do SOLID
 * SRP (Single Responsibility Principle) - A classe tem uma única responsabilidade, que é gerar o relatório de reparos.
...
@Controller
@RequestMapping("/relatorioreparo")
public class ReparosRelatorioController {
    ...
    public ResponseEntity relatorio(@RequestParam("data") String data, ModelMap model) {
        ...
        try {
            String path = "classpath:reports/Reparos.jasper";
